...
> **创建日期**: 2026-02-03
> **最后更新**: 2026-02-03
> **代码版本**: v1.1.0（manifest.json）
> **状态**: ✅ 代码 v1.1.0 已发布 | 🔲 v1.2.0 规划中

---

## 修订记录

| 规格书版本 | 日期 | 变更说明 | 对应代码版本 |
|-----------|------|----------|-------------|
| 1.0.0-draft | 2026-02-03 | 初始草案 | - |
| 1.1.0 | 2026-02-03 | 根据审计报告修订：移除 eval、补充数据合同、明确 Dataview 依赖、修复存储策略等 | - |
| 1.2.0 | 2026-02-03 | 完成插件脚手架搭建：M1-M4 里程碑已实现，添加路径自动补全功能 | v1.1.0 ✅ |
| 1.2.1 | 2026-02-03 | 增加移动端支持，插件测试通过并正式发布 | v1.1.0 ✅ |
| 1.3.0 | 2026-02-03 | 整合周期任务管理器：支持在弹窗中生成周期任务到 Daily Note | v1.2.0 🔲 |
